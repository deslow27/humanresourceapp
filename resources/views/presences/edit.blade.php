            ...
            <div class="card-body">
                ...
                <form action="{{ route('presences.update', $presence->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control datetime" name="check_out" value="{{ old('check_out', $presence->check_in) }}" required>
                        @error('check_out')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control date" name="date" value="{{ old('date', $presence->check_in) }}" required>
                        @error('date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
