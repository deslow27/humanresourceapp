...
class HumanResourceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table("departments")->insert([
            [
                'name' => 'HR', 'description' => 'Departemen Human Resources', 
                'status' => 'active', 
                'created_at' => Carbon::now(), 
                'updated_at' => Carbon::now()
            ],
            [
                'name' => 'IT', 'description' => 'Departemen Information Tech', 
                'status' => 'active', 
                'created_at' => Carbon::now(), 
                'updated_at' => Carbon::now()
            ],
            [
                'name' => 'Sales', 'description' => 'Departemen Sales', 
                'status' => 'active', 
                'created_at' => Carbon::now(), 
                'updated_at' => Carbon::now()
            ],
        ...
        DB::table("tasks")->insert([
            [
                ...
                'assigned_to' => 1, 
                'due_date' => Carbon::parse('2026-09-15'), 
                'status' => 'pending', 
                'created_at' => Carbon::now(), 
                'updated_at' => Carbon::now()
            ],
        ...
        DB::table("payroll")->insert([
            [
                ...
                'pay_date' => Carbon::parse('2026-09-15'), 
                'created_at' => Carbon::now(), 
                'updated_at' => Carbon::now()
            ],
            [
        ...
        DB::table("presences")->insert([
            [
                'employee_id' => 1, 
                'check_in' => Carbon::parse('2026-08-10 09:00:00'), 
                'check_out' => Carbon::parse('2026-08-10 17:00:00'), 
        ...
        DB::table("leave_requests")->insert([
            [
                ...
                'start_date' => Carbon::parse('2026-08-20'), 
                'end_date' => Carbon::parse('2026-08-23'), 
                'status' => 'pending', 
                'created_at' => Carbon::now(), 
                'updated_at' => Carbon::now(),
            ],
